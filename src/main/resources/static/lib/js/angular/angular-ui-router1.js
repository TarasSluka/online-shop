 ...
 * }
     ...
     * // and the second element is a function that returns a value of the input
     * let firstTuple = [ angular.isString, (input) => `Heres your string ${input}` ];
     *
     * // Second tuple: predicate "isNumber", mapfn returns a value
 ...
 * }
    ...
    function pick(obj, propNames) {
        ...
        propNames.forEach(function (prop$$1) {
            if (isDefined(obj[prop$$1]))
...
// TODO: explicitly make this user configurable
     ...
     * });
        ...
        Transition.prototype.run = function () {
            ...
            services.$q.when()
                .then(function () {
                    return chainFor(exports.TransitionHookPhase.BEFORE);
                })
                .then(function () {
                    return chainFor(exports.TransitionHookPhase.RUN);
                })
